  ...
  return (
    <>
      ...
      <ToolbarGroup>
        ...
        >
          <SquarePlay size={16} />
          <span className="tiptap-button-text hidden md:block">Youtube</span>
        </Button>
      </ToolbarGroup>
...
export const SimpleEditor = React.forwardRef(function SimpleEditor(
  { content, onUpdate }: SimpleEditorProps,
  ref
) {
  ...
  const { run: handleUpdate } = useDebounceFn(
    ({ editor }) => {
    ...
    extensions: [
      ...
      ImageUploadNode.configure({
        ...
        onError: error => {
          ...
          toast.error(error.message || COMMON_ERROR.UNKNOWN.message)
        }
      }),
      TrailingNode,
      ...
      >
        {mobileView === 'main' ? (
          <MainToolbarContent
            ...
            addYoutubeVideo={handlerAddYoutubeVideo}
            isMobile={isMobile}
          />
        ) : (
